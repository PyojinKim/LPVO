function [xi] = estimatePoseRotationTranslation(ipRelations, cam, optsLAPO)
...
for iterCount = 1:iterNum
    ...
    for i = 1:ipRelationsNum
        ...
        if (abs(ipr.v) < 0.5) % no depth point
            ...
            jacobianTemp = df_nodepth_dxi([tx; ty; tz; phi; theta; psi; u2; v2; 0; 0; 0; u1; v1]);
        ...
        elseif (abs(ipr.v - 1) < 0.5 || abs(ipr.v - 2) < 0.5) % with depth point
            ...
            Y_1 = v1 * ipr.s;
            Z_1 = ipr.s;
            jacobian1Temp = df_depth_1_dxi([tx; ty; tz; phi; theta; psi; u2; v2; X_1; Y_1; Z_1; u1; v1]);
            jacobian2Temp = df_depth_2_dxi([tx; ty; tz; phi; theta; psi; u2; v2; X_1; Y_1; Z_1; u1; v1]);
